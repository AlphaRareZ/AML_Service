...
public class LigandMessageProducer(IConfiguration configuration, ILogger<LigandMessageProducer> logger)
    : IMessageProducer<LigandMessage>, IAsyncDisposable
{
    ...
    private readonly string _requestQueue = configuration["RabbitMQ:ligand_request_queue"] ?? "request_queue";
    ...
    public async Task<int> PublishAsync(LigandMessage message, CancellationToken ct)
    {
